...
$q1 = "SELECT count(*) as total
        FROM booking_master
        WHERE book_start_date >= CURRENT_DATE
        AND  book_status = '1'";
            ...
            <div style="height:100%;border:1px solid #ccc;font:15px/20px Georgia, Garamond, Serif;overflow:auto;">
              ...
              <table>
                ...
                while($row = mysqli_fetch_array($result))
                {
                  ...
                  <td><a href="passbuttonProcess.php?book_id=<?php echo $row["book_id"];?>&amp;
                          ...
                          staffemail=<?php echo $qrow["staff_email"];?>">Pass Key</a></td>
                  </tr>
                  <?php
                  $i++;
                }
