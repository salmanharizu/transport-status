              ...
              <table>
                ...
                while($row = mysqli_fetch_array($result))
                {
                  ...
                  <tr class="<?php if(isset($classname)) echo $classname;?>">
                    ...
                    <td><a href="returnbuttonform.php?book_id=<?php echo $row["book_id"];?>&amp;
                          book_carno=<?php echo $row["book_carno"];?>&amp;
                          cartoservice=<?php echo $row["car_to_service"];?>&amp;
                          ...
                          staffemail=<?php echo $qrow["staff_email"];?>">Key Return</a></td>
                  </tr>
                  <?php
                  $i++;
                }
