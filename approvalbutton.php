            ...
            <div style="height:100%;border:1px solid #ccc;font:15px/20px Georgia, Garamond, Serif;overflow:auto;">
              ...
              <table>
                ...
                while($row = mysqli_fetch_array($result))
                {
                  ...
                  <td><a href="approveProcess.php?book_id=<?php echo $row["book_id"];?>&amp;
                            ...
                            staffemail=<?php echo $qrow["staff_email"];?> onclick="clickAndDisable(this);"">Approve</a></td>
                  </tr>
                  <?php
                  $i++;
                }
