          ...
          <div class="card-body">
            <table>
                <tr>
                  ...
                  <td style="width: 3300px"><input type="text" id="book_id" class="form-control" placeholder=""  name="bid" value="<?php echo $_GET['book_id'] ?>" readonly/>
                  <td style="width: 1200px"><label for='book_carno' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Car</label></td>
                  <td style="width: 3200px"><input type="text" id="bcarnoname" class="form-control" placeholder="" name="bcarnoname" value="<?php echo $_GET['book_carno']." - ". $qcardet['car_name']?>" readonly/>
                  <td style="width: 200px"><input type="hidden" id="bcarno" class="form-control" placeholder="" name="bcarno" value="<?php echo $_GET['book_carno'] ?>" readonly/>
                </tr>
                <tr>
            ...
            <div class="form-group">
              <tr>
                ...
                <td style="width: 510px"><input type="text" id="book_desc" class="form-control" placeholder=""  name="bdesc" value="<?php echo $_GET['book_desc']?>" readonly/></td>
              </tr>
            </div>
            ...
            <div class="form-group">
                <tr>
                  ...
                  <td style="width: 570px"><input type="text" id="returnby" class="form-control" placeholder=""  name="returnby" value="<?php echo $_GET['staffid'].' - '.$_GET['staffshortname'].' ('. $_GET['staffemail'].')' ?>" readonly/></td>
                </tr>
              </div>
            </table>
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="emailid" class="form-control" placeholder="ID" name="emailid" value="<?php echo $emailid ?>" readonly/>
								<input type="hidden" id="staffid" class="form-control" placeholder=""  name="staffid" value="<?php echo $_GET['staffid'] ?>" readonly/>
								<input type="hidden" id="staffname" class="form-control" placeholder=""  name="staffname" value="<?php echo $_GET['staffname'] ?>" readonly/>
								<input type="hidden" id="staffemail" class="form-control" placeholder=""  name="staffemail" value="<?php echo $_GET['staffemail'] ?>" readonly/>
            </div>
